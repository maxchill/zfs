 ...
 *	The activity check waits up to 10*MAX(zfs_mmp_interval, mmp_delay) ms
 ...
 */
void
mmp_update_uberblock(dsl_pool_t *dp, uberblock_t *ub)
{
	mmp_thread_state_t *mmp = &dp->dp_mmp;
 ...
 */
static void
mmp_write_uberblock(dsl_pool_t *dp)
{

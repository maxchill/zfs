    ...
    dmu_object_type_t bonustype, int bonuslen, int dn_slots, dmu_tx_t *tx)
{
	...
	/*
	 * Since no dnode_hold_impl(os, object, DNODE_MUST_BE_FREE, ...) is
	 * done for reallocation the requested number of slots may not be
	 * free.  Therefore the dnode size cannot be safely expanded and
	 * will spill if required.
	 */

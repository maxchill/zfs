...
log_assert "FIEMAP reports pending free extents as unwritten"
log_onexit cleanup
...
for recordsize in 4096 8192 16384 32768 65536 131072 ; do
	...
	fiemap_free $BS 1
	fiemap_verify -H 0:$BS:1 -F "unwritten:1"
	fiemap_verify -s -H 0:$BS:1 -F "unwritten:1"
	fiemap_remove
	...
	fiemap_free $BS 8
	fiemap_verify -H 0:$((BS*8)):1 -F "delalloc,unwritten:1"
	fiemap_verify -s -H 0:$((BS*8)):1 -F "unwritten:1"
	fiemap_remove
...
log_pass "FIEMAP reports pending free extents as unwritten"

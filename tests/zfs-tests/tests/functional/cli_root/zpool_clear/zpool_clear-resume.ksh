...
#
# XXX - The remainder of this test case is disabled until zpools which
# cannot be resumed can always be successfully hard force exported (-F).
# At the moment this is not always the case and may require a reboot.
#
